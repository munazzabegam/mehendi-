  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="display: flex; justify-content: last baseline;">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="add_design.php" style="margin: 0px 30px 0px 30px;  padding: 5px 10px 5px 10px;font-weight: 600; border-radius: 1px; color: #ffff;">Add Photo</a>
        </li>
      </ul>
    </div>
  </div>
...
<div id="carouselExampleIndicators" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="../assets/images/slide1.jpg" class="d-block w-100" style="max-height: 400px; width: 100%; object-fit: cover;" alt="...">
    </div>
